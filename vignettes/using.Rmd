...
You will want to prevent student access to the `.secrets` folder. Deploying your app to a server will not give such access. But other things you might do can reveal the account access token, for example using a GitHub repo without "ignoring" the folder.
